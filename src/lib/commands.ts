import { Command, DeepScanOpts, KillProcessOpts, KillProcessResult } from "@/lib/types";
...
const deepScan = (path: DeepScanOpts): Promise<void> => invoke(Command.DeepScan, path);
